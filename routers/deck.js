...
const {validateBody, schemas, name, validateParam} = require('../helpers/routerHelpers');
...
router.route('/:deckID')
    ...
    .patch(validateParam(schemas.idSchema, 'deckID'), validateBody(schemas.optionDeck), DeckController.updateDeck)
