...
router.route('/password/forgot').post(validateBody(schemas.emailSchema), UserController.forgotPassword);

router.route('/password/reset').post(validateBody(schemas.resetPasswordSchema), UserController.resetPassword);
